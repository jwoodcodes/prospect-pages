...
export default function DataTable({ data }) {
  ...
  const [dataSetToDisplay, setDataSetToDisplay] =
    React.useState("prospect grades");
      ...
      <div className={styles.dataTableSelectsWrapper}>
        ...
        >
          ...
          <select
            ...
            onChange={(event) => {
              ...
              event.target.value === "all"
                ? setPositionForDataTable("all")
                : setPositionForDataTable(event.target.value);
        ...
        >
          ...
          <select
            ...
            className={styles.clsSelect}
          >
            <option value={"prospect grades"}>prospect grades</option>
            <option value={"passing"}>passing</option>

            <option value={"rushing & receiving"}>rushing & receiving</option>
            <option value={"all"}>All</option>
          </select>
        </form>
      </div>
